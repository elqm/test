...
public class Application {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 상속 관계로 형성된 모든 객체는 동일한 메세지를 수신할 수 있다.
		 * 하지만 객체 별로 그 메세지에 응답하는 방식은 서로 다를 수 있다. (다형성)
		 * */
		Car car = new Car();
		car.soundHorn();
		car.run();
