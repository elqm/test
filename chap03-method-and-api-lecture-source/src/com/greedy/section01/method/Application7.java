...
public class Application7 {
	...
	public static void main(String[] args) {
		...
		/* 매개변수와 리턴값 복합 활용 */
		/* 매개변수도 존재하고 리턴값도 존재한는 메소드를 이용하여 간단한 계산기 만들기 */
		...
		System.out.println("두 수를 곱한 결과 : " + app7.multupleTwoNumbers(first, second));
	 ...
	 * 첫 번째 매개변수로 전달받은 정수에서 두 번째 매개변수로 전달받은 정수를 뺸 결과값을 반환하는 기능 제공
	 * </pre>
	 ...
	 * @paran second 곱하기를 할 두 번째 정수
	 * @return 매개변수로 전달 받은 두 수의 곱셈 결과
	 * */
	
	public int multupleTwoNumbers(int first, int second) {
	 ...
	 * 단, 두 번째 매개변수를 0으로 하면 ArithmeticException이 발생할 수 있으므로 주의해서 사용해야 함
	 * </pre>
	 * @param fitst 나누기를 할 첫 번째 정수
